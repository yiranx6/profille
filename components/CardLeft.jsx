...
function CardLeft({title, text, pic, time, courses}) {
    ...
    <div className="bg-white w-full md:w-3/4 lg:w-1/2">
      ...
      <div className="h-full mx-auto px-6 md:px-0 md:-pt-6 md:-ml-6 relative">
        ...
        <div className="bg-white lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap lg:flex-wrap items-center">
          ...
          <div className="w-full lg:w-3/5 lg:px-3">
            <text className="text-md md:text-lg lg:text-xl xl:text-2xl mt-4 lg:mt-0 text-justify md:text-left">
            {text}
            <ul>
               {courses ? 
               courses.map(c=>{
