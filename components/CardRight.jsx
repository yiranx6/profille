...
function CardRight({title, text, pic, time, courses}) {
  ...
  return (
      ...
      <div className="shadow-left flex flex-wrap flex-row-reverse w-full mx-auto">
      <div className={`bg-cover bg-bottom border w-full md:w-1/4 lg:w-1/2 h-64 md:h-auto`}>
  ...
  <div className="bg-white w-full md:w-3/4 lg:w-1/2">
    ...
    <div className="h-full mx-auto px-6 md:px-0 md:-pt-6 md:-ml-6 relative">
      ...
      <div className="bg-white lg:h-full p-6 mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
        ...
        <div className="w-full lg:w-1/5 lg:border-right lg:border-solid text-center md:text-left md:pr-40">
          <h3  className=" text-xl md:text-2xl lg:text-3xl -right-2">{title}</h3>
        ...
        <div className="w-full lg:w-3/5 lg:px-3">
          <p className="text-md md:text-lg lg:text-xl xl:text-2xl mt-4 lg:mt-0 text-justify md:text-left">
          {text}
          <ul>
             {courses ? 
             courses.map(c=>{
                 return (
                     <li key={c._id}>
                      <span className="font-bold">{c.genre}</span>
                          {c.tech}
                     </li>
                 )
             }): "loading..."
